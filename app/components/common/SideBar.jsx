...
const SideBar = () => {
  return (
    <div className="h-screen w-[15%] md:w-[19%] sm-md:w-[12%] lg:w-[25%] pt-4 border-r border-slate-800 overflow-hidden md:pl-10 lg:pl-4">
      <div className="flex flex-col md:w-[80%] self-center">
        <div className="flex flex-col gap-7">
          ...
          <Link
            href="/"
            className="self-center lg:self-start p-2  hover:bg-stone-800 hover:rounded-full"
          >
          ...
          <Link href="/notifications" className="self-center lg:self-start p-2 hover:bg-stone-800 hover:rounded-full">
            <label className="flex gap-2 items-center cursor-pointer">

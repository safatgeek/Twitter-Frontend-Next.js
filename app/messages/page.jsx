...
const MessagePage = () => {
  ...
  const messages = [
    { username: "Tanjim Alam", handle: "@tanjim", time: "2h", message: "last message" },
    { username: "John Doe", handle: "@johndoe", time: "5h", message: "another message" },
    // Add more messages here if needed
  ];

  return (
    <div className="w-screen md:w-[59%] sm-md-md:w-[75%] sm-md:w-[80%] lg:w-[46%] flex flex-col gap-6 border-r border-slate-800 py-4">
      ...
      <div className="px-4">
        <label className="input input-bordered flex items-center gap-2 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
          <svg
      ...
      {messages.length != 0 && (
        ...
        <div
          ...
          className={`flex gap-2 items-center cursor-pointer p-4 hover:bg-[#121416] ${
            selectedMessageIndex === index ? "bg-[#202327]" : "bg-transparent"
          }`}
        ...
        >
          ...
          <div className="flex flex-col w-full">
            <div className="flex gap-1 h-5 items-start">
              <span className="text-sm text-white font-semibold">{msg.username}</span>
